...
class Trainer:
    ...
    def prepare_dataloader(self, train_dataset, eval_dataset):
        ...
        data_trainloader = DataLoader(dataset = train_dataset, batch_size=batch_size,sampler=SequentialSampler(train_dataset), collate_fn=DataCollatorForSeq2Seq(tokenizer = tokenizer, return_tensor = 'pt'))
        ...
        data_testloader = DataLoader(dataset=eval_dataset, batch_size=batch_size, sampler=SequentialSampler(eval_dataset),collate_fn=DataCollatorForSeq2Seq(tokenizer = tokenizer, return_tensor = 'pt'))
